...
population_options <- list(
  ...
  age3 = demo_population("wa",
    "county",
    "age 18-39",
    sex = "both sexes"
  ),
  age4 = demo_population("wa",
    "county",
    "age 40-64",
    sex = "both sexes"
  ),
  age5 = demo_population(
    "wa",
    "county",
    "ages 40 and over"
  ),
  age6 = demo_population(
    "wa",
    "county",
    "ages 50 and over"
  ),
  race1 = demo_population(
    "wa",
    "county",
    "foreign born",
    "all races (includes hispanic)", "both sexes"
  ),
  sex1 = demo_population("wa",
    "county",
    "males",
    race = "all races (includes hispanic)"
  ),
  sex2 = demo_population("wa",
    "county",
    "females",
    race = "all races (includes hispanic)"
  )
